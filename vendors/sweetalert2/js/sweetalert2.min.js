...
function() {
    ...
    function r() {
        if (void 0 === arguments[0]) return console.error("SweetAlert2 expects at least 1 attribute!"),
        !1;
        var e = v({},
        Q);
        ...
        return new Promise(function(n, o) {
            ...
            function l(t) {
                ...
                if ( - 1 !== [9, 13, 32, 27].indexOf(a)) {
                    for (var l = n.target || n.srcElement,
                    s = A(e.focusCancel), c = -1, u = 0; u < s.length; u++) if (l === s[u]) {
                        c = u;
                        break
                    }
            ...
            for (d = 0; d < v.length; d++) v[d].onclick = f,
            v[d].onmouseover = f,
            v[d].onmouseout = f,
            v[d].onmousedown = f;
            P().onclick = function() {
            ...
            window.onkeydown = l,
            e.buttonsStyling && (g.style.borderLeftColor = e.confirmButtonColor, g.style.borderRightColor = e.confirmButtonColor),
            ...
            i.enableInput = function() {
                var e = s();
                if (!e) return ! 1;
                if ("radio" === e.type) for (var t = e.parentNode.parentNode,
                n = t.querySelectorAll("input"), o = 0; o < n.length; o++) n[o].disabled = !1;
                else e.disabled = !1
            },
            i.disableInput = function() {
                var e = s();
                if (!e) return ! 1;
                if (e && "radio" === e.type) for (var t = e.parentNode.parentNode,
                n = t.querySelectorAll("input"), o = 0; o < n.length; o++) n[o].disabled = !0;
                else e.disabled = !0
            },
            ...
            r( - 1, 1),
            a.scrollTop = 0,
            "undefined" == typeof MutationObserver || m || (m = new MutationObserver(i.recalculateHeight), m.observe(t, {
                childList: !0,
                characterData: !0,
                subtree: !0
            }))
    ...
    Z = function(e) {
        ...
        var p;
        if (e.text || e.html) {
            if ("object" == typeof e.html) if (r.innerHTML = "", 0 in e.html) for (p = 0; p in e.html; p++) r.appendChild(e.html[p].cloneNode(!0));
        ...
        if (e.type) {
            ...
            if (!h) return console.error("SweetAlert2: Unknown alert type: " + e.type),
            !1;
        ...
        e.imageUrl ? (b.setAttribute("src", e.imageUrl), H(b), e.imageWidth ? b.setAttribute("width", e.imageWidth) : b.removeAttribute("width"), e.imageHeight ? b.setAttribute("height", e.imageHeight) : b.removeAttribute("height"), b.className = c.image, e.imageClass && M(b, e.imageClass)) : O(b),
        ...
        e.buttonsStyling && (a.style.backgroundColor = e.confirmButtonColor, l.style.backgroundColor = e.cancelButtonColor),
        a.className = c.confirm,
        M(a, e.confirmButtonClass),
        l.className = c.cancel,
        M(l, e.cancelButtonClass),
        e.buttonsStyling ? (M(a, c.styled), M(l, c.styled)) : (T(a, c.styled), T(l, c.styled), a.style.backgroundColor = a.style.borderLeftColor = a.style.borderRightColor = "", l.style.backgroundColor = l.style.borderLeftColor = l.style.borderRightColor = ""),
    ...
    F = function(t, o) {
        ...
        K && !q(r, c.noanimation) ? r.addEventListener(K,
        function i() {
    ...
    i.close = i.closeModal = function(e) {
        ...
        K && !q(n, c.noanimation) ? n.addEventListener(K,
        function d() {
    ...
    i.noop = function() {},
    i.version = "5.3.8",
    "function" == typeof Promise ? Promise.prototype.done = Promise.prototype.done ||
    function() {
