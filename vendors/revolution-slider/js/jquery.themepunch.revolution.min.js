                ...
                if (f.hasClass("tp-videolayer") || f.find("iframe").length > 0 || f.find("video").length > 0) {
                    ...
                    if (f.find("video").length > 0) {
                        f.find("video").each(function(n) {
                            ...
                            var o = s.parent();
                            if (i.addEventListener) i.addEventListener("loadedmetadata",
                            function() {
                                o.data("metaloaded", 1)
                            });
                            else i.attachEvent("loadedmetadata",
                            function() {
                                o.data("metaloaded", 1)
                            });
                            ...
                            o.data("interval", setInterval(function() {
                                if (o.data("metaloaded") == 1 || i.duration != NaN) {
                                    ...
                                    if (!o.hasClass("HasListener")) {
                                        ...
                                        if (i.addEventListener) i.addEventListener("play",
                                        function() {
                                        ...
                                        if (i.addEventListener) i.addEventListener("pause",
                                        function() {
                                        ...
                                        if (i.addEventListener) i.addEventListener("ended",
                                        function() {
                                            o.removeClass("videoisplaying");
                                            r.videoplaying = false;
                                            r.container.trigger("starttimer");
